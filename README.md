...
<img src="./exec/image/U_2.0.0_진단하기.png" width="270">
<br/><br/>

- 전용 IoT 기기를 통한 AI 두피 건강 진단
  <br/><br/>
  ![IoT기기_진단](./exec/image/IoT기기_진단.gif)
  <br/><br/>

- 휴대폰 카메라 촬영을 통한 AI 두피 건강 진단
  <br/><br/>  
  ![핸드폰_진단](./exec/image/핸드폰_진단.gif)

### 2. 진단 결과를 모아보는 마이리포트

![마이리포트](./exec/image/마이리포트.gif)

### 3. 두피 상태에 맞는 두피 케어 루틴 추천, 알림

<img src="./exec/image/U_4.0.0_데일리___다이어리__비로그인___1_ (1).png" width="270">
<br/><br/>

- AI 진단 결과를 기반으로 사용자 맞춤형 두피 케어 루틴 추천
  <br/><br/>  
  ![루틴설정](./exec/image/루틴설정.gif)
  <br/><br/>

- 루틴별 알림 설정 시 원하는 시간에 Push 알림 수신
  <br/><br/>
  ![알람](./exec/image/알람.gif)  
  <br/><br/>

### 4. 생활 습관으로 예측해보는 두피TI

<img src="./exec/image/두피TI메인.png" width="270">  
<br/><br/>

- 생활 습관 문진을 기반으로 나의 두피 타입 예측

![두피ti](./exec/image/두피ti.gif)
<br/><br/><br/>
...
![Group_49](./exec/image/Group_49.png)
<br/><br/><br/>
