...
function SetScalpTI3() {
  ...
  const handleButtonClick = () => {
    setSelect((prevSelect) => {
      ...
      updatedSelect[2] = selectedIndex as number;
      return updatedSelect;
    });
    console.log(select);

    navigate('/set-scalpti4');
  };
  return (
    <>
      <div className="col-span-full relative h-screen">
        <div ref={containerRef}>
          <div className="col-start-1 col-end-7">
            ...
            <div className="flex">
              <div className="h-[0.188rem] w-[42%] bg-Main "></div>
              <div className="h-[0.188rem] w-[58%] bg-Gray "></div>
            </div>
          </div>
