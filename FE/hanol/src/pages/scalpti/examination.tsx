...
function Examination() {
  ...
  // const type1 =
  //   '유. 수분의 밸런스 붕괴로 인한 두피면역력 저하가 트러블을 유발하는 두피유형입니다. \r\n건성 두피는 피지 분비가 부족해 말라있는 것이 특징입니다. 말라있는 두피를 건강하기 위해서는, 유분과 수분의 밸런스를 조절해 맞춰주는 것이 좋습니다. 말라있기 때문에 가려운 증상을 보이곤 하는데, 그럴 때 샴푸를 더 한다거나 머리를 자주 감는 것은 부족한 두피의 유분을 더 소실시키는 결과를 초래합니다. 샴푸는 하루에 한 번 하는 것이 좋고, 두피 세럼이나 트리트먼트, 헤어 마스크 등을 사용해 두피에 충분한 영양을 공급해주는 방식으로 관리할 수 있습니다.';
  // const type2 = '';
            ...
            {scalpType && scalpType.type3 && (
              <div>
                ...
                <div className="text-[0.8125rem]">
                  ...
                  쉬운 두피 상태이기 때문에 지성 두피와 함께 지루성 두피염이 발생하기 쉬운 타입입니다. ”<br />
                </div>
              </div>
            )}
